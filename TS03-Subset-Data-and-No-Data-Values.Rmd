...
interest, air temperature, precipitation, and photosynthetically active radiation (PAR) in regards to plant phenology.  
...
the same as lack of data (we didn't measure the rain today). Beware--some .csv
files use blank to indicate 'zero', this is why checking the metadata is essential!
