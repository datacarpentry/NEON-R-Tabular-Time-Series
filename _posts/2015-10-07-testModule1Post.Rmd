---
layout: post
title: "Lesson Title Goes here - RMD File"
...
### The section below is your objectives block. it's in HTML
...
```{r name-of-chunk}
#the chunk name is used for saving IMAGES associated with the knitted output
#please include a UNIQUE NAME for each chunk

#here is some code in a code chunk
apple <- 5

```

### section two
Some text about some concept being taught
