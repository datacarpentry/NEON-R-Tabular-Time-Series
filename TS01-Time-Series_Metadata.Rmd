...
Because we used the`stringsAsFactors=FALSE` command, data types that are 
...
When you are examining data you've obtained from others, this extra step of investigation 
