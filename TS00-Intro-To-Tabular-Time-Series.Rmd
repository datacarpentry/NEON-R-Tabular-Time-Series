...
In this lesson, we will explore micro-meterology data collected from a flux
tower at the NEON Harvard Forest field site. We are interested in exploring 
...
platforms (MAC, PC, LINUX, etc) and also can be read by many different tools.  
