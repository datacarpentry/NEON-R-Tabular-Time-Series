---
layout: post
title: "Time Series 05: Plotting Time Series with ggplot in R"
date:   2015-10-20
...
description: "This tutorial uses ggplot2 to create professional plots of time 
...
## About
This tutorial uses `ggplot2` to create professional plots of time 
series data. We will learn how to adjust x- and y-axis ticks using the scales
package, how to add trend lines to a scatter plot and how to customize plot
labels, colors and overall theme.
