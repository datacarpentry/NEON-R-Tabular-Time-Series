...
within date-time and other objects check out the 
`R` documentation by using `?` (E.G., `?POSIXlt`). NOTE: you can use this same syntax to
learn about particular functions (E.G., `?ggplot`).  
{: .notice}
