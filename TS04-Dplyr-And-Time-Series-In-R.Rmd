...
an National Ecological Observatory Network <a href="http://www.neoninc.org/science-design/field-sites/harvard-forest" target="_blank">field site</a>. These data are proxy data for what will be available for 30 years
...
performed data "munging" tasks. It uses the `data_frame` object as both an input and 
an output.
