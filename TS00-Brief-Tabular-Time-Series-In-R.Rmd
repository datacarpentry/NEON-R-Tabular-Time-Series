...
value to an actual date-time class that can be displayed quantitatively. Lucky 
for us, `R` has a `date` class.  We can reassign the `date` field using
`as.Date`.
...
much more quickly now that R recognizes the date as a date field. `R` can 
