...
convert a date data, stored as a character string, into a date class that R can
...
After completing this lesson, you will:
  ...
  * Understand how to work with different columns in `data.frame` in `R`.
...
much more quickly now that R recognizes the date as a date class. `R` can 
