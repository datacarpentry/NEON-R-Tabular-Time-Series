...
From our descriptives we can visualize in our minds what the general temperature flucturation across each year looks like, but it would be a lot nicer if we created a plot to visually show this. To do this, we're going to use `ggplot2` to plot the air temperature across our 2 year span time span for each 15 minute data point.
