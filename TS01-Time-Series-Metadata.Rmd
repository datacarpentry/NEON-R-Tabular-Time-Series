---
layout: post
title: "Lesson 01: Investigating Time Series Metadata"
date:   2015-10-24
...
Load any packages prior to importing and working with the data.  At this point we
...
code allows us to denote each library's purpose in the script. This will help 
...
Again, it is a good practice to make relevant notes from the metadata in the R 
