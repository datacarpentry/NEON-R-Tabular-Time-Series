...
If completing EML portion of tuturial on your own, you must
...
explicetedly teach all details of how to use it. Instead, we will provide
an example of how you can access `EML` programmatically and background 
...
are aggregated at various time intervales (15 minute, daily, etc) and that date 
back to 2001.
...
meterological metrics, including precipiation and temperature (and associated
...
The above example, demonstated how we can extract information from an `EML`
