...
class: [As covered in the lesson: Dealing With Dates & Times in R - as.Date, POSIXct, POSIXlt]({{ site.baseurl }}/R/Time-Series-Metadata/). 
...
1. Import the Daily Meteorological data from the Harvard Forest (if you haven't already 
done so in the [Intro to Time Series Data in R - Managing Date / Time Format and Simple Plots using ggplot2 lesson ]({{site.baseurl}}/R/Brief-Tabular-Time-Series-qplot/ "for HarMet_Daily"). )
